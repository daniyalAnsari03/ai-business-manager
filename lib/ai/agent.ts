...
export function buildBusinessManagerInstructions(
  ...
  return [
    ...
    "- When the user says they already approved a publish action (e.g. 'krdi hay approve ab post kro fb pr', 'approve ho gaya hai, ab publish karo'), FIRST use the find_approval_action tool with the postId to check if an existing approval action exists.",
